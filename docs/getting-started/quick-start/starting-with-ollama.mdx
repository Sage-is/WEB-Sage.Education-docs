...
If you’re looking for a faster option to get started, you can download models directly from the **Model Selector**. Simply type the name of the model you want, and if it’s not already available, Sage.is AI-UI will prompt you to download it from Ollama.
