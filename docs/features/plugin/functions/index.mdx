...
Functions are like **plugins** for Sage.is AI-UI. They help you **extend its capabilities**—whether it’s adding support for new AI model providers like Anthropic or Vertex AI, tweaking how messages are processed, or introducing custom buttons to the interface for better usability.  

Unlike external tools that may require complex integrations, **Functions are built-in and run within the Sage.is AI-UI environment.** That means they are fast, modular, and don’t rely on external dependencies.  
...
There are **three types of Functions** in Sage.is AI-UI, each with a specific purpose. Let’s break them down and explain exactly what they do:
...
- Pipes don’t even have to use AI! They can be setups for **search APIs**, **weather data**, or even systems like **Home Assistant**. Basically, anything you’d like to interact with can become part of Sage.is AI-UI.  

**Use case example:**  
Imagine you want to query Google Search directly from Sage.is AI-UI. You can create a Pipe Function that:  
...
Here's how to put Functions to work in Sage.is AI-UI:

### 1. **Install Functions**  
You can install Functions via the Sage.is AI-UI interface or by importing them manually. You can find community-created functions on the [Sage.is AI-UI Community Site](https://sage.education/functions).
...
Functions are designed for anyone who wants to **unlock new possibilities** with Sage.is AI-UI:  
...
Whether you’re customizing workflows for specific projects, integrating external data, or just making Sage.is AI-UI easier to use, Functions are the key to taking control of your instance.
...
By leveraging Functions, you’ll bring entirely new capabilities to your Sage.is AI-UI setup. Start experimenting today! 🚀