...
Many Tools are available to use on the [Community Website](https://sage.education/tools) and can easily be imported into your Sage.is AI-UI instance. 
...
4) You can now upload the Tool into Sage.is AI-UI by navigating to Workspace => Tools and clicking “Import Tools”

### Import via your Sage.is AI-UI URL
...
4) Enter the IP address of your Sage.is AI-UI instance and click “Import to WebUI” which will automatically open your instance and allow you to import the Tool.
