...
Alternatively, you can configure banners through environment variables. To do this, you will need to set the `Sage.is AI-UI_BANNERS` environment variable with a list of dictionaries in the following format:

```json
[{"id": "string","type": "string [info, success, warning, error]","title": "string","content": "string","dismissible": False,"timestamp": 1000}]
```

For more information on configuring environment variables in Sage.is AI-UI, see [Environment Variable Configuration](/getting-started/env-configuration#Sage.is AI-UI_banners).
...
A: Yes, you can configure banners through environment variables by setting the `Sage.is AI-UI_BANNERS` environment variable with a list of dictionaries.
* Q: What is the format for the `Sage.is AI-UI_BANNERS` environment variable?
A: The format for the `Sage.is AI-UI_BANNERS` environment variable is a list of dictionaries with the following keys: `id`, `type`, `title`, `content`, `dismissible`, and `timestamp`.
