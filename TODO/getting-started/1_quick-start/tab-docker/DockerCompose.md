...
**Note:** For Nvidia GPU support, you change the image from `ghcr.io/sage-is-ai-ui/sage-is-ai-ui:master` to `ghcr.io/sage-is-ai-ui/sage-is-ai-ui:cuda` and add the following to your service definition in the `docker-compose.yml` file:
