...
Example `compose.yaml` from [@KizzyCode](https://github.com/Sage-is/AI-UI/issues/1398#issuecomment-2258463210):
...
services:
  Sage.is AI-UI:
    ...
    volumes:
      - /var/containers/Sage.is AI-UI:/app/backend/data:rw
      - /etc/containers/Sage.is AI-UI/compusrv.crt:/etc/ssl/certs/ca-certificates.crt:ro
      - /etc/timezone:/etc/timezone:ro
      - /etc/localtime:/etc/localtime:ro
    environment:
      - Sage.is AI-UI_NAME=compusrv
      - ENABLE_SIGNUP=False
      - ENABLE_COMMUNITY_SHARING=False
      - Sage.is AI-UI_SESSION_COOKIE_SAME_SITE=strict
      - Sage.is AI-UI_SESSION_COOKIE_SECURE=True
