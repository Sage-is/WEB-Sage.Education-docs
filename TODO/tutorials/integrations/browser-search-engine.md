...
- The `Sage.is AI-UI_URL` environment variable is set correctly, either using Docker environment variables or in the `.env` file as specified in the [Getting Started](/getting-started/env-configuration) guide.

### Step 1: Set the Sage.is AI-UI_URL Environment Variable

Setting the `Sage.is AI-UI_URL` environment variable ensures your browser knows where to direct queries.
...
docker run -d \
  ...
  --name sage-is-ai-ui \
  --restart always \
  -e Sage.is AI-UI_URL="https://<your-sage-is-ai-ui-url>" \
...
```plaintext
Sage.is AI-UI_URL=https://<your-sage-is-ai-ui-url>
```
...
4. Fill in the details as follows:
    ...
    - **Keyword**: Sage.is AI-UI (or any keyword you prefer)
...
```
Sage.is AI-UI your search query
```
...
- Ensure the `Sage.is AI-UI_URL` is correctly configured and points to a valid Sage.is AI-UI instance.
